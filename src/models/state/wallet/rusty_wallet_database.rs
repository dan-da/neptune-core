...
impl RustyWalletDatabase {
    pub async fn connect(db: NeptuneLevelDb<RustyKey, RustyValue>) -> Self {
        ...
        let mut tables = Self::load_schema_in_order(&mut storage).await;
    ...
    async fn load_schema_in_order(storage: &mut SimpleRustyStorage) -> WalletDbTables {
...
pub(crate) mod migrate_db {
    ...
    mod v0_to_v1 {
        ...
        pub(super) async fn migrate(storage: &mut SimpleRustyStorage) -> anyhow::Result<()> {
            ...
            let sent_transactions_v0 = load_v0_schema_in_order(storage).await;
        ...
        async fn load_v0_schema_in_order(
            ...
            // let _ = storage.schema.new_singleton::<u64>("symmetric_key_counter").await;
            // let _ = storage.schema.new_vec::<Digest>("guesser_preimages").await;
            // let _ storage.schema.new_singleton::<u16>("schema_version").await;
        }
        ...
        mod test {
            ...
            struct RustyWalletDatabaseV0 {
                ...
                pub sent_transactions: DbtVec<SentTransactionV0>, // table 3
            }
