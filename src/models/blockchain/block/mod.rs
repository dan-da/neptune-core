...
impl Block {
    ...
    fn premine_distribution() -> Vec<(ReceivingAddress, NeptuneCoins)> {
        ...
        vec![
            ...
            // Actual premine recipients, added 2024-011-18
